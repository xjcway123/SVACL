...
data_paths = [
    "E:/xjc/SVACL/SVACL/data/data1/train.xlsx",
    "E:/xjc/SVACL/SVACL/data/data2/train.xlsx",
    "E:/xjc/SVACL/SVACL/data/data3/train.xlsx",
    "E:/xjc/SVACL/SVACL/data/data4/train.xlsx",
    "E:/xjc/SVACL/SVACL/data/data5/train.xlsx"
]

test_paths = [
    "E:/xjc/SVACL/SVACL/data/data1/test.xlsx",
    "E:/xjc/SVACL/SVACL/data/data2/test.xlsx",
    "E:/xjc/SVACL/SVACL/data/data3/test.xlsx",
    "E:/xjc/SVACL/SVACL/data/data4/test.xlsx",
    "E:/xjc/SVACL/SVACL/data/data5/test.xlsx"
]
...
for i in range(1, 6):
    ...
    if i == 1:
        ...
        # 根据置信度抽取样本
        indices_to_replay = np.argsort(confidences_train)[-200:]  # 假设抽取100个样本
    ...
    validation_dataloader = PromptDataLoader(
        dataset=read_prompt_examples(r"E:/xjc/SVACL/SVACL/data/data" + str(i) + "/valid.xlsx"),
        template=mytemplate,
        tokenizer=tokenizer, tokenizer_wrapper_class=WrapperClass, max_seq_length=max_seq_l,
        batch_size=batch_size, shuffle=True,
        teacher_forcing=False, predict_eos_token=False, truncate_method="head",
