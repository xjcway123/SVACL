...
def main():
    ...
    if args.do_train:
        ...
        for epoch in range(args.num_train_epochs):
            ...
            if args.do_eval:
                ...
                precision, recall, f1_score, _ = precision_recall_fscore_support(f1, f, average='macro')
    ...
    if args.do_test:
        model.load_state_dict((torch.load(
            os.path.join("E:\wjy\SOTitlePlus\SOTitlePlus\model_code\output_dir\checkpoint-best-f1-t5based",
                         "pytorch_model_f1-t5based.bin"), map_location=torch.device('cuda:0'))))
        files = []
